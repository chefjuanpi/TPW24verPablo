...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div style="margin-left: 20%; margin-right: 20%; overflow: auto;">
        ...
        <div class="moitie">
            <div>
                ...
                <div><strong style="font-size: 18px;">
                    <asp:Label ID="lblUtilisateur" runat="server" Text="" /></strong></div>
            </div>
            <div>
                <div class="titre">Prenom :</div>
                <div>
                    <asp:TextBox runat="server" ID="txtPrenom" Enabled="false" /></div>
                <div>
            ...
            <div>
                ...
                <div>
                    <asp:TextBox runat="server" ID="txtNom" Enabled="false" /></div>
                <div>
            ...
            <div>
                ...
                <div>
                    <asp:TextBox runat="server" ID="txtCourriel" Enabled="false" /></div>
                <div>
            ...
            <div>
                ...
                <div>
                    <asp:TextBox ID="txtCreated" runat="server" Enabled="false" /></div>
            </div>
            <div>
                <div class="titre">dernier conection le :</div>
                <div>
                    <asp:TextBox ID="txtLast" runat="server" Enabled="false" /></div>
            </div>
            <br />
            <br />
        </div>
        <div>
            ...
            <a id="seeMessagesLink" class="btn btn_blue" href='../SeeMessages.aspx' runat="server">Voir messages</a>
            <br />
            <br />
            <br />
            <a id="sendMessageLink" class="btn btn_blue" runat="server" href='../SendMessages.aspx'>Envoyer message</a><br />
        </div>
    </div>
    <br />
